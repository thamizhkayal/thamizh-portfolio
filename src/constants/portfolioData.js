...
export const profile = {
  ...
  tagline:
    'Full-Stack Developer on a mission to ship high-impact web and mobile products with MERN + Flutter.',
  location: 'Pondicherry, India',
  email: 'thamizharasan2373@gmail.com',
...
export const education = [
  'B.Sc Computer Science - Deccan Educational and Research Foundation (May 2019)',
  'High School Diploma - Government Higher Secondary School, Nonankuppam (Mar 2015)',
  'Node.js Certification - Udemy',
]

export const socialLinks = [
  { label: 'GitHub', url: 'https://github.com/thamizhkayal' },
  { label: 'LeetCode', url: 'https://leetcode.com/thamizharasan2373' },
  {
    label: 'Codingame',
    url: 'https://www.codingame.com/certification/b_J41ZFJBVTnCcpy4k1Jzw',
  },
  {
    label: 'Udemy Certificate',
    url: 'https://www.udemy.com/certificate/UC-15aa8352-acc8-406d-a553-edf9ca98dc62/',
  },
]
